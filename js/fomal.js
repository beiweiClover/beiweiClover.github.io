...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | beiweiClover")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'DO2BZ-E4A64-BG7US-F32HN-Q2OO5-AXBRC',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
if ((y == 2025 && m == 4 && dd == 4) || (y == 2026 && m == 4 && dd == 5) || (y == 2027 && m == 4 && dd == 5)) {//清明节
  if (sessionStorage.getItem("isPopupWindow") != "1") {
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<div style="font-size:13px;font-weight:bold">本站已经运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒啦~ <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<div style="font-size:13px;font-weight:bold">本站已经运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒啦~ <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (window.localStorage.getItem("fpson") == undefined || window.localStorage.getItem("fpson") == "1") {
  ...
  var loop = function () {
    ...
    //   if (fps <= 5) {
    //     var kd = `<span style="color:#bd0000">卡成ppt o((>ω< ))o </span>`
    //   } else if (fps <= 15) {
    ...
    //   } else {
    //     var kd = `<span style="color:#39c5bb">十分流畅 ( •̀ ω •́ )✧</span>`
    //   }
    ...
    if (now > 1000 + lastTime) {
      ...
      if (fps <= 5) {
        kd = `<span style="color:#bd0000">卡成ppt o((>ω< ))o </span>`;
      } else if (fps <= 15) {
        kd = `<span style="color:red">非常卡顿</span>`;
      } else if (fps <= 25) {
        ...
        kd = `<span style="color:#39c5bb">十分流畅 ( •̀ ω •́ )✧</span>`;
      }
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/img/default.jpg);
    --darkmode-bg:url(/img/darkmode1.jpeg);
    --mobileday-bg: url(/img/mobileday.jpg);
    --mobilenight-bg: url(/img/mobilenight.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<a class="swf" id="swf_default" href="javascript:;" rel="noopener external nofollow" style="font-family:-apple-system, IBM Plex Mono, monospace, '微软雅黑', sans-serif !important;color:black;" onclick="setFont('default')">系统默认</a>
</p>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/default.jpg)" class="imgbox" onclick="changeBg('url(/img/default.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/darkmode1.jpeg)" class="imgbox" onclick="changeBg('url(/img/darkmode1.jpeg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/darkmode2.jpg)" class="imgbox" onclick="changeBg('url(/img/darkmode2.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0001.jpg)" class="imgbox" onclick="changeBg('url(/img/0001.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0002.jpg)" class="imgbox" onclick="changeBg('url(/img/0002.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0003.jpg)" class="imgbox" onclick="changeBg('url(/img/0003.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0006.jpg)" class="imgbox" onclick="changeBg('url(/img/0006.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0009.jpg)" class="imgbox" onclick="changeBg('url(/img/0009.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0005.jpg)" class="imgbox" onclick="changeBg('url(/img/0005.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/1716988798497.jpg)" class="imgbox" onclick="changeBg('url(/img/1716988798497.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0004.jpg)" class="imgbox" onclick="changeBg('url(/img/0004.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/0008.jpeg)" class="imgbox" onclick="changeBg('url(/img/0008.jpeg)')"></a></div>
              </div>
            </details>
